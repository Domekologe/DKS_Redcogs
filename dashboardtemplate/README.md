# DashboardTemplate — Vorlage zum Migrieren ans DKS Web Dashboard
...
### 1. Drop-in kopieren
Kopiere `dks_dashboard.py` unverändert in deinen Cog-Ordner. Diese Datei hat **keine
harte Abhängigkeit**: Ist `webdashboard` nicht installiert, werden die Decorators zu
...
Mixin/Decorators also unverändert behalten und zusätzlich die DKS-Panels ergänzen. Es
