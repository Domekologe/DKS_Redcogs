...
class ThirdPartyConverter(commands.Converter):
    async def convert(self, ctx: commands.Context, argument: str) -> str:
        cog = ctx.bot.get_cog("DKS-Dashboard") or ctx.bot.get_cog("Dashboard")
...
class Dashboard(Cog):
    ...
    **Installation guide:** https://red-web-dashboard.readthedocs.io/en/latest
    ...
    __cog_name__: str = "DKS-Dashboard"
    ...
    async def create_app(self, flask_flags: typing.List[str]) -> None:
